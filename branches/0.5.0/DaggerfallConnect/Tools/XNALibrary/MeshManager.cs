...
namespace XNALibrary
{
    ...
    public class MeshManager
    {
        ...
        {
            get { return textureManager.ImageFileReader; }
        }
        ...
        /// Default constructor.
        /// </summary>
        public MeshManager(GraphicsDevice device, string arena2Folder)
        {
            textureManager = new TextureManager(device, arena2Folder);
            arch3dFile.Load(Path.Combine(arena2Folder, "ARCH3D.BSA"), FileUsage.UseDisk, true);
