...
namespace DaggerfallConnect
{
    ...
    public class DFPalette
    {
        ...
        public bool Load(string FilePath)
        {
            ...
            if (file.Length != reader.Read(PaletteBuffer, 0, (int)file.Length))
                return false;
        ...
        public Color Get(int Index)
        {
            ...
            Color col = Color.FromArgb(PaletteBuffer[offset], PaletteBuffer[offset + 1], PaletteBuffer[offset + 2]);
        ...
        public ColorPalette GetManagedColorPalette()
        {
            // Create a new bitmap to "steal" a palette from
            Bitmap bitmap = new Bitmap(1, 1, PixelFormat.Format8bppIndexed);
            ColorPalette palette = bitmap.Palette;
            bitmap.Dispose();

            // Set colours of this palette
            for (int i = 0; i < 256; i++)
            {
                palette.Entries[i] = Get(i);
            }
