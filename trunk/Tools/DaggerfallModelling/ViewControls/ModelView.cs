...
namespace DaggerfallModelling.ViewControls
{
    ...
    public class ModelView : ViewBase
    {
        ...
        public override void Initialize()
        {
            ...
            modelVertexDeclaration = new VertexDeclaration(
                VertexPositionNormalTexture.VertexDeclaration.GetVertexElements());

            // Setup model basic effect
            modelEffect = new BasicEffect(host.GraphicsDevice);
            ...
            lineEffect = new BasicEffect(host.GraphicsDevice);
        ...
        private void DrawSingleModel()
        {
            ...
            // Set vertex buffer
            host.GraphicsDevice.SetVertexBuffer(currentModel.VertexBuffer);
